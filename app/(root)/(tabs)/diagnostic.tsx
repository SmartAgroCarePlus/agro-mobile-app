...
export default function Diagnostic() {
    ...
    return (
        <ScrollView className="flex-1 bg-background px-6" contentContainerStyle={{ paddingBottom: 24 }}>
            <LoadingOverlay visible={isLoading} message="Analyse en cours..." />

            <Text className="text-2xl font-bold text-foreground mb-2">Diagnostiquer votre plante</Text>
